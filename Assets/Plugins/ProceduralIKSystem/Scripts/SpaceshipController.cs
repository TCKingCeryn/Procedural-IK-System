...
public class SpaceshipController : MonoBehaviour {
    ...
    void Update()
    {
        ...
        Vector3 lookInput = Vector3.ClampMagnitude(new Vector3(Input.GetAxis("Mouse Y") * -1f, Input.GetAxis("Mouse X"), - Input.GetAxis("Horizontal")), 1f) * lookSpeed * Time.deltaTime;
