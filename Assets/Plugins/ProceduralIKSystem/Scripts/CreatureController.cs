...
public class CreatureController : MonoBehaviour {
    ...
    private void Move() {
        mSpeed = (Input.GetKey(KeyCode.LeftShift) ? sprintSpeed : walkSpeed);
        ...
        rSpeed = Mathf.MoveTowards(rSpeed, Input.GetAxis("Horizontal") * rotationSpeed, rotateInputFactor * Time.deltaTime);
